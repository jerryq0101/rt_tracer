...
3. Enable Tracepoints inside of the kernel variant, meaning `CONFIG_TRACEPOINTS=y` inside linux-menuconfig (make linux-menuconfig and type / in the menu to find `CONFIG_TRACEPOINTS`' dependencies)
